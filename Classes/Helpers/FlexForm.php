 ...
 * @version     SVN: $Id$
 */
class tx_egovapi_helpers_flexform {
	...
	protected function initialize(array $settings) {
		...
		$this->settings = tx_egovapi_helpers_ts::getMergedConfiguration($this->settings, array(), self::$globalTS);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/egovapi/Classes/Helpers/FlexForm.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/egovapi/Classes/Helpers/FlexForm.php']);
}
