 ...
 * @version     SVN: $Id$
 */
class tx_egovapi_helpers_objects {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/egovapi/Classes/Helpers/Objects.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/egovapi/Classes/Helpers/Objects.php']);
}
