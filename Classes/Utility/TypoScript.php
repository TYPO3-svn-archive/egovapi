...
class tx_egovapi_utility_ts {
	...
	public static function preprocessConfiguration(tslib_cObj $cObj, array $settings) {
		...
		$globalParameters = array(
			...
			// Pi2
			'template', 'ajaxLoader', 'service', 'version', 'latitude', 'longitude',
			// Pi1 used by Pi2
			'dynamicConfig',
		);
...
if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/egovapi/Classes/Utility/TypoScript.php'])) {
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/egovapi/Classes/Utility/TypoScript.php']);
}
