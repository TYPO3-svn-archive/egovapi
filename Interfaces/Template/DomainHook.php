...
/**
 * Hook interface for the prepare domain process.
 *
 ...
 * @version     SVN: $Id$
 */
interface tx_egovapi_interfaces_template_domainHook {
	 ...
	 * @return void
	 */
	public function postProcessDomainSubpartsMarkers(tx_egovapi_domain_model_domain $domain, $mode, array &$subparts, array &$markers, tx_egovapi_controller_pi1_templateRenderer $pObj);
