...
/**
 * Hook interface for the prepare topic process.
 *
 ...
 * @version     SVN: $Id$
 */
interface tx_egovapi_interfaces_template_topicHook {
	 ...
	 * @return void
	 */
	public function postProcessTopicSubpartsMarkers(tx_egovapi_domain_model_topic $topic, $mode, array &$subparts, array &$markers, tx_egovapi_controller_pi1_templateRenderer $pObj);
